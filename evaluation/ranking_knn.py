...
generator = SourceFileLoader("gen_images", "/import/bc_users/biocomp/stym/depoibens/stylegan3-repo.gen_images").load_module()
dnnlib = SourceFileLoader("dnnlib", "stylegan3-repo.dnnlib").load_module()
legacy = SourceFileLoader("legacy", "stylegan3-repo.legacy").load_module()L
