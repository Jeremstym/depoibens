            ...
            for real_image, label in pbar:            
                ...
                for seed_idx, seed in enumerate(seeds):
                    ...
                    if testing:
                        ...
                        accuracy_test.extend(((output_fake == 0) * 1).item())
                        accuracy_test.extend(((output_real == 1) * 1).item())
                        ...
                        accuracy.extend(((output_fake == 0) * 1).item())
                        accuracy.extend(((output_real == 1) * 1).item())
