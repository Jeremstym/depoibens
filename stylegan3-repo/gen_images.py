        ...
        if genes is True:
            ...
            for real_image, label in pbar:            
                ...
                for seed_idx, seed in enumerate(seeds):
                    ...
                    output_fake = ((torch.nn.functional.sigmoid(logits_fake) > 0.5) * 1).to(torch.float32)
                    ...
                    output_real = ((torch.nn.functional.sigmoid(logits_real) > 0.5) * 1).to(torch.float32)
                    ...
                    if testing:
                        ...
                        accuracy_test.append((output_fake == 0) * 1)
                        accuracy_test.append((output_real == 1) * 1)
                        ...
                        accuracy.append((output_fake == 0) * 1)
                        accuracy.append((output_real == 1) * 1)
